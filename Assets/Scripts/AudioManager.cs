...
public class AudioManager : BaseManager<AudioManager>
{
    ...
    public void PlayBGM(string bgmName, float fadeSpeedRate = BGM_FADE_SPEED_RATE_HIGH)
    {
        ...
        //ifBGM is not currently playing, play it as is
        ...
        //when a different BGM playing, fade out the BGM that is playing before playing the next one through when the same BGM is playing
    ...
    public void Update()
    {
        ...
        //Gradually lower the volume, and when the volume reaches 0, return the volume and play the next song
    ...
    public void ChangeSEVolum(float SEVolume)
    {
